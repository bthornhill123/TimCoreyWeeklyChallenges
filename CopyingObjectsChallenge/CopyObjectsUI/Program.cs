...
namespace CopyObjectsUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 1.) First way to perform a deep copy on an object - using NewtonSoft
            ...
            // 2.) Second way to perform a deep copy on an object - using a copy contructor
            //      The reason why you would use copy constructors is because it gives you a lot more control over the copying 
            // process. JSON serializing just does it blindly.
            ...
            secondPerson.Addresses[1].StreetAddress = "707 S 1545 W";
